...
/**
 * Represents an immutable tracing context snapshot, including the current span and its trace.
 *
 * <p>A {@link TraceContextSnapshot} carries the identifiers used for distributed tracing, typically
...
public interface TraceContextSnapshot {
   ...
   * {@link TraceContext#open()} and/or {@link OpenContext#close()} methods.
   *
   ...
   *     TraceContextImpl#open()} and/or {@link OpenContext#close()} calls, or {@link Duration#ZERO}
   *     if the context is not fully opened and closed
   */
